...
import com.apps.instagramclone.materialcamera.util.Degrees;
import com.apps.instagramclone.materialcamera.util.ImageUtil;
import com.apps.instagramclone.materialcamera.util.ManufacturerUtil;

import static com.apps.instagramclone.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_BACK;
import static com.apps.instagramclone.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_FRONT;
import static com.apps.instagramclone.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_UNKNOWN;
import static com.apps.instagramclone.materialcamera.internal.BaseCaptureActivity.FLASH_MODE_ALWAYS_ON;
import static com.apps.instagramclone.materialcamera.internal.BaseCaptureActivity.FLASH_MODE_AUTO;
import static com.apps.instagramclone.materialcamera.internal.BaseCaptureActivity.FLASH_MODE_OFF;
...
public class CameraFragment extends BaseCameraFragment implements View.OnClickListener {
  ...
  com.apps.instagramclone.materialcamera.internal.CameraPreview mPreviewView;
...
//      Log.d(TAG, "openCamera: height: " + height);
  ...
  private void createPreview() {
    ...
    if (mWindowSize == null) mWindowSize = new Point();
    activity.getWindowManager().getDefaultDisplay().getSize(mWindowSize);
    mPreviewView = new com.apps.instagramclone.materialcamera.internal.CameraPreview(getActivity(), mCamera);
    if (mPreviewFrame.getChildCount() > 0 && mPreviewFrame.getChildAt(0) instanceof com.apps.instagramclone.materialcamera.internal.CameraPreview)
