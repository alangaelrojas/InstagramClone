...
import com.apps.instagramclone.easyvideoplayer.EasyVideoCallback;
import com.apps.instagramclone.easyvideoplayer.EasyVideoPlayer;
...
public class PlaybackVideoFragment extends Fragment
  ...
  public static PlaybackVideoFragment newInstance(
    ...
    args.putBoolean(com.apps.instagramclone.materialcamera.internal.CameraIntentKey.ALLOW_RETRY, allowRetry);
    args.putInt(com.apps.instagramclone.materialcamera.internal.CameraIntentKey.PRIMARY_COLOR, primaryColor);
  ...
  public void onViewCreated(View view, Bundle savedInstanceState) {
    ...
    if (getArguments().getBoolean(com.apps.instagramclone.materialcamera.internal.CameraIntentKey.ALLOW_RETRY, true))
